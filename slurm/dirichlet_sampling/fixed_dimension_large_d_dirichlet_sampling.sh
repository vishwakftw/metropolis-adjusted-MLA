...
inv_dimension_threefourth=`bc -l <<< "scale=8; 1/sqrt(sqrt(${dimension}^3))"`
...
d_mult_list=(${inv_dimension_threefourth} ${inv_dimension} ${inv_dimension_onehalf} ${inv_dimension_sqr})
c_mult=0.25
